...
Given /^(?:|I )am on the details page for "(.+)"$/ do |movie_title|
  ...
  visit path_to("movies/#{movie_id}")
end

When /^(?:|I )go to the edit page for "(.+)"$/ do |movie_title|
  movie_id = Movie.find_by_title(movie_title).id
  visit path_to("movies/#{movie_id}/edit")
end

Then /^(?:|I )should be on the Similar Movies page for "(.+)"$/ do |movie_title|
  movie = Movie.find_by_title(movie_title)
  expect(page).to have_content "Similar Movies for #{movie.title}"
end
...
Then /^the "([^"]*)" checkbox(?: within (.*))? should not be checked$/ do |label, parent|
  with_scope(parent) do
    field_checked = find_field(label)['checked']
    if field_checked.respond_to? :should
      field_checked.should be_false else assert !field_checked
    end
  end
end
 
Then /^(?:|I )should be on the home page$/ do
  expect(page.title).to eq 'Rotten Potatoes!'
end
